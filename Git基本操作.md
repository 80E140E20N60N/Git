...
#### 1.7.1.1. 注册 github 流程

1、在浏览器中打开 [www.github.com，点击](http://www.github.xn--com%2C-8e9fh24n/) Sign up 后进入注册页面

2、填写`用户名、邮箱、密码(必须保证至少8个字符，包括一个数字和一个小写字母)`

3、点击`请回答此问题，以证明您是真人`中的`验证`按钮完成真人验证

4、点击 `Create account` 按钮即可创建账号

5、进入到 欢迎页面后 拉到最底部点击 `Complate setup`按钮

6、登录到你在第 2 步填写好的邮箱中，查找验证邮件，点击里边的验证链接即可完成注册

![](http://157.122.54.189:9092/upload/zybdoc/git/imgs/26.png)
...
#### 1.7.2.1. 注册码云流程（国内网络快）

1、在浏览器中打开 [www.gitee.com，点击](http://www.gitee.xn--com%2C-8e9fh24n/) **注册** 后进入注册页面

2、填写`用户名、邮箱、密码`

3、点击`发送验证码`后进行人机交互，进入邮箱中将验证码复制到文本框中
